...
/********************************************************
	DESIGNE LOS FILTROS QUE DESEA OBVIAR
	AGREGAR '-- ', sin comillas ANTES DE LA ETIQUETA 'SET'
************************************************************/
...
-- SET @hEstablecimiento = 'QUILCAPUNCO';
...
WHERE    
	...
	AND N.CODIGO_ITEM IN ('U071','U072','B972','Z208')
ORDER BY
    ANIO,
    CAST(MES AS INT),
	ME.DISTRITO,
	...
	N.FECHA_ATENCION,
	CONCAT(MA.APELLIDO_PATERNO_PERSONAL,' ',MA.APELLIDO_MATERNO_PERSONAL,' ',MA.NOMBRES_PERSONAL),
	N.CODIGO_ITEM
	ASC;